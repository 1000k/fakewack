      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">@{'username'}さんがフォロー中</p>
          </div>
        </div>
      </header>
        ...
        {following.map((user) => (
          <div key={user.id} className="p-4 flex items-center justify-between">
            ...
            <button
              ...
              className="ml-4 px-4 py-1.5 rounded-full text-sm font-medium bg-white text-gray-800 border border-gray-300 hover:bg-gray-50"
            >
              フォロー中
            </button>
          </div>
